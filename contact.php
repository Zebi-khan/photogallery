...
<div class="info py-5">
  <div class="container">
    <div class="row">
      <div class="col-4">
        <div class="card bg-white border-0 rounded-0 mb-2 py-2">
          <div class="card-body">
          ...
          <div class="card-body">
            <ul class="list-unstyled d-flex align-items-center m-0">
              <li class="d-flex align-items-center">
                ...
                <a href="email: info@photogallery.cc" class="text-decoration-none text-dark">info@photogallery.cc</a>
              </li>
            </ul>
          </div>
        </div>
        <div class="card bg-white border-0 rounded-0 mb-2 py-2">
          <div class="card-body">
            <ul class="list-unstyled d-flex align-items-center m-0">
              <li class="d-flex align-items-center">
                <i class="me-2"><img src="/assets/images/call2.png" alt="call" width="24"></i>
                <a href="tel: (123) 456-7890" class="text-decoration-none text-dark">(123) 456-7890 (Fax Address)</a>
              </li>
            </ul>
          </div>
        </div>
